...
const Register = () => {
  ...
  return (
    <div className="w-full text-black flex-center py-10 bg-[url('https://res.cloudinary.com/dufuwsrue/image/upload/v1715966233/rwd_img_wide_001_xigkl2.jpg')] bg-no-repeat bg-cover bg-center">
